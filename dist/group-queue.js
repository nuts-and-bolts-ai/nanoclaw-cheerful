...
export class GroupQueue {
    ...
    releaseFolder(folder) {
        ...
        if (waiters && waiters.length > 0) {
            ...
            if (waiters.length === 0)
                this.folderWaiters.delete(folder);
            next();
        }
    }
     ...
     */
    sendMessage(groupJid, text, threadTs) {
        const state = this.getGroup(groupJid);
