...
```
<internal>Querying Supabase for campaign data before summarizing.</internal>

Here's the summary of your campaigns...
```
...
- Create files for structured data (e.g., `clients.md`, `preferences.md`, `decisions.md`)
